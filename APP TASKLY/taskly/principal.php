...
if ($_GET["menu"]=="editarUsuarios")
	...
	if ($_GET["menu"]=="agregar_tipoPoliza")
	include_once 'tipopoliza/agregar_tipoPoliza.php';
	
	if ($_GET["menu"]=="editar_tipoPoliza")
	...
	if ($_GET["menu"]=="agregar_vehiculoPropietario")
	include_once 'vehiculopropietario/agregar_vehiculoPropietario.php';
	
		if ($_GET["menu"]=="editar_vehiculoPropietario")
	...
	if ($_GET["menu"]=="formulario")
	include_once 'reportes/formulario.html';
